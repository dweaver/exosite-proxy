...
var _node_modulesSuperagentLibClientJs = require('../node_modules/superagent/lib/client.js');
...
var ApiService = (function () {
    function ApiService(token) {
        var apiServer = arguments.length <= 1 || arguments[1] === undefined ? 'https://proxy.exositeapp.com' : arguments[1];
    ...
    _createClass(ApiService, [{
        ...
        value: function buildRequest() {
            return _node_modulesSuperagentLibClientJs2['default'].post(this.apiServer + this.apiRootUri).set('Authorization', 'Bearer ' + this.token).set('Accept', 'application/json').set('Content-Type', 'application/json');
        }
    }, {
        key: 'rpc',
        value: function rpc(clientId, calls) {
            var _this = this;
        ...
        key: 'getTimeSeries',
        value: function getTimeSeries(deviceId, dataportRid, limit, since, onSuccess, onError) {
            var _this2 = this;
            ...
            return new Promise(function (resolve, reject) {
                _this2.buildRequest().send(requestObj).end(function (err, res) {
                    console.log(err, res);
                    if (res.ok && !err) {
                        resolve(res.text);
                    } else {
        ...
        key: 'mapReads',
        value: function mapReads(device, rids, resources) {
        ...
        key: 'getDeviceChildrenInfo',
        value: function getDeviceChildrenInfo(devices) {
            var _this4 = this;
            ...
            var devicesWithRids = _.map(devices, function (device) {
                return {
                    ...
                    rids: _.flatten(_.map(_.zip(device.dataport, device.datarule, device.dispatch, device.client), function (rids) {
                        return _.filter(rids, function (rid) {
...
},{"../node_modules/superagent/lib/client.js":2,"lodash":1}],6:[function(require,module,exports){
'use strict';
...
},{"../node_modules/superagent/lib/client.js":2}],7:[function(require,module,exports){
/**
 * Exosite Fleet
...
var _ApiServiceJs = require('./ApiService.js');

var _ApiServiceJs2 = _interopRequireDefault(_ApiServiceJs);

window.Exosite = _ExositeJs2['default'];
window.ApiService = _ApiServiceJs2['default'];

exports['default'] = { Exosite: _ExositeJs2['default'], ApiService: _ApiServiceJs2['default'] };
module.exports = exports['default'];

},{"./ApiService.js":5,"./Exosite.js":6}]},{},[7]);
